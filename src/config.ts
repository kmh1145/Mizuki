...
export const siteConfig: SiteConfig = {
	title: "昆明湖的博客",
	subtitle: "Ciallo～(∠・ω< )⌒☆",
	siteURL: "https://blog.nnyunidc.cn/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/kmh1145/Mizuki",
					external: true,
				...
				{
					name: "统计",
					url: "https://cloud.umami.is/share/IHmXa0TEz1PYtnUc",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // 启用看板娘
	models: ["/pio/models/murasame/Murasame.model3.json"], // 默认模型路径
...
export const umamiConfig = {
	...
	apiKey:
		import.meta.env.UMAMI_API_KEY || "api_L4VsUTnzNjSmNFBZWTm7csxDwYiRHw3E", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="51157e3d-063f-41a9-98da-d936991ed5d9"></script>
